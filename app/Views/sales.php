...
<body>
    ...
    <main>
        ...
        <div class="container-md">
            <button type="button" title="Adicionar venda" class="btn btn-success" id="btnAdd" data-bs-toggle="modal" data-bs-target="#salesModal">
            ...
            <div class="modal fade" id="salesModal" tabindex="-1" aria-labelledby="salesModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="salesModalLabel">Modal title</h1>
